    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    @permission('permission-add-new-data')
                    <div class="float-right">
                        <a href="{{ route('permission.create') }}" class="btn btn-sm bg-gradient-success">Add New</a>
                    </div>
                    @endpermission
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if (\Laratrust::isAbleTo('permission-edit-data'))
                                                <a href="{{ route('permission.edit', ['permission' => $item->id]) }}" class="btn btn-xs bg-gradient-info" data-toggle="tooltip" data-placement="top" title="Edit">
